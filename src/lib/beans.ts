...
import { SupabasePeopleProvider } from './server/people/provider/supabase'
import { peopleInMemory } from './people/in-memory/people'
import { MemoryNotesProvider } from './shared/notes/provider/memory'
import { SupabaseNotesProvider } from './server/notes/provider/supabase'
import { MemoryTagsProvider } from './shared/tags/types/provider/memory'
import { SupabaseTagsProvider } from './server/tags/provider/supabase'
